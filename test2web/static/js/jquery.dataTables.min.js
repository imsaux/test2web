...
(function (i, V, l, n) {
    var j = function (e) {
        ...
        }, fnStateSaveParams: null, iCookieDuration: 7200, iDeferLoading: null, iDisplayLength: 50, iDisplayStart: 0, iScrollLoadGap: 100, iTabIndex: 0, oLanguage: {
            oAria: { sSortAscending: ": 显示升序", sSortDescending: ": 显示降序" }, oPaginate: { sFirst: "第一条", sLast: "最后一条", sNext: "下一条", sPrevious: "上一条" }, sEmptyTable: "暂无数据", sInfo: "显示 _START_ 到 _END_ 条记录， 共计 _TOTAL_ 条记录。",
            sInfoEmpty: "显示 0 条记录", sInfoFiltered: "(检索自 _MAX_ 条记录)", sInfoPostFix: "", sInfoThousands: ",", sLengthMenu: "显示 _MENU_ 记录", sLoadingRecords: "加载中...", sProcessing: "处理中...", sSearch: "查询:", sUrl: "", sZeroRecords: "未查询到相关记录"
    ...
    j.defaults.columns = { aDataSort: null, asSorting: [], bSearchable: !0, bSortable: !0, bUseRendered: !0, bVisible: !0, fnCreatedCell: null, fnRender: null, iDataSort: -1, mDataProp: null, sCellType: "td", sClass: "", sContentPadding: "", sDefaultContent: null, sName: "", sSortDataType: "std", sTitle: null, sType: null, sWidth: null }; j.models.oSettings = {
