...
(function (i, V, l, n) {
    ...
    j.defaults = {
        ...
        iTabIndex: 0,
        oLanguage: {
            oAria: {sSortAscending: ": 显示升序", sSortDescending: ": 显示降序"},
            oPaginate: {sFirst: "第一条", sLast: "最后一条", sNext: "下一条", sPrevious: "上一条"},
            sEmptyTable: "暂无数据",
            sInfo: "显示 _START_ 到 _END_ 条记录， 共计 _TOTAL_ 条记录。",
            sInfoEmpty: "显示 0 条记录",
            sInfoFiltered: "(检索自 _MAX_ 条记录)",
            sInfoPostFix: "",
            sInfoThousands: ",",
